...
function Toast({ toast, onRemove }: ToastProps) {
  ...
  return (
    <div
      className={[
        'flex items-start gap-3 px-4 py-3 rounded-xl bg-gray-900 border border-gray-800',
        'border-l-4 shadow-xl min-w-[280px] max-w-[380px]',
...
function notify(listeners: ((t: ToastMessage[]) => void)[], newToasts: ToastMessage[]) {
  toasts = newToasts
...
export const showToast = (message: string, type: ToastType = 'info') => {
  ...
  notify(toastListeners, [...toasts, { id, message, type }])
}
